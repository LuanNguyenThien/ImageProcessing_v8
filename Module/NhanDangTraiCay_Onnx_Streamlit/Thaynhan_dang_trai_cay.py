...
classes = ['Apple', 'Mango', 'Orange', 'Watermelon' , 'Pear']
# Constants.
INPUT_WIDTH = 640
INPUT_HEIGHT = 640
SCORE_THRESHOLD = 0.5
...
def nhan_dang_trai_cay():
    try:
        ...
        st.session_state["Net4"] = cv2.dnn.readNet(r".\\Module\\NhanDangTraiCay_Onnx_Streamlit\\nhan_dang_trai_cay.onnx")
        print(st.session_state["LoadModel4"])
    ...
    with col2:
        ...
        if img_file_buffer is not None:
            ...
            col3.image(image, caption='Input', use_column_width=True)
            if st.button('Predict'):
                ...
                col4.image(img_color, channels='RGB', caption='Output', use_column_width=True)
